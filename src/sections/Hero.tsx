  ...
  return (
    ...
    >
      ...
      {heroConfig.stats.length > 0 && (
        <div className={`absolute bottom-6 sm:bottom-20 left-0 right-0 z-10 transition-all duration-1000 ease-out ${phase >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          <div className="container-custom px-4">
            <div className="grid gap-4 sm:gap-8 max-w-3xl mx-auto" style={{ gridTemplateColumns: `repeat(${heroConfig.stats.length}, minmax(0, 1fr))` }}>
